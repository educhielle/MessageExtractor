...
HD_PWD='C:/Projects/MessageExtractor/MessageExtractor/MessageExtractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MessageExtractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MessageExtractor.tcl -notrace
