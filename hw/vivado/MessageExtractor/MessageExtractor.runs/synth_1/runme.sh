...
HD_PWD='C:/Projects/MessageExtractor/MessageExtractor/MessageExtractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MessageExtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MessageExtractor.tcl
